 ...
 *   https://datatables.net/download/#bs5/dt-2.1.6/b-3.1.2/fh-4.0.1/kt-2.12.1/r-3.0.3/rg-1.5.0/rr-1.5.0/sc-2.4.3/sp-2.3.2/sl-2.0.5
 *
 * Included libraries:
 *   DataTables 2.1.6, Buttons 3.1.2, FixedHeader 4.0.1, KeyTable 2.12.1, Responsive 3.0.3, RowGroup 1.5.0, RowReorder 1.5.0, Scroller 2.4.3, SearchPanes 2.3.2, Select 2.0.5
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.1.6/b-3.1.2/fh-4.0.1/kt-2.12.1/r-3.0.3/rg-1.5.0/rr-1.5.0/sc-2.4.3/sp-2.3.2/sl-2.0.5",
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 */
			"sInfo": " _START_ ~ _END_ 총 _TOTAL_ _ENTRIES-TOTAL_",
			 ...
			 */
			"sInfoEmpty": " 0 ~ 0 총 0 _ENTRIES-TOTAL_",
			 ...
			 */
			"sLengthMenu": "_MENU_ _ENTRIES_ 씩 보기",
